...
This repository currently contains the planning, brand foundation, logo assets,
and design references. The Next.js application has not been bootstrapped yet.

The next implementation step is:

1. Preserve and commit the current planning/brand baseline.
2. Bootstrap the Next.js/Supabase project using
   `docs/plan-bootstrap-mobile-first.md`.
...
6. `docs/design/README.md` - design handoff guide and asset map.
...
Commands will become available after bootstrap:
